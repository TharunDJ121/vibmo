...
class FoldableBookPhone(Node):
    ...
    def add_screen_content(self, *nodes: Node) -> FoldableBookPhone:
    ...
    def draw(self, ctx: Any, time: float = 0.0) -> None:
        ...
        ctx.save()
        _rounded_rect(ctx, self.bezel_width, self.bezel_width, w - self.bezel_width * 2, h - self.bezel_width * 2, cr - 8.0)
        ctx.clip()
        ...
        pat.add_color_stop_rgba(0.5, 0, 0, 0, 0.2)
...
class ClamshellFlipPhone(Node):
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.hinge_angle = Signal(180.0, f"{self.name}.hinge_angle")
...
class DualScreenBookDevice(Node):
    ...
    def draw(self, ctx: Any, time: float = 0.0) -> None:
        ...
        hinge_pat.add_color_stop_rgba(0.5, 0.3, 0.3, 0.3, 1.0)
